...
">
        ...
        <form id="donor-form" class="form-section" method="POST" action="process_registration.php">
        ...
        <form id="receiver-form" class="form-section" method="POST" action="process_registration.php">
